...
% ---- Test pour montrer la nécessité d'introduire au non-linéaire ------ %
...
virginica_indices = strcmp(species, 'setosa');
...
legend({'Classe 1 : virginia', 'Classe -1 : Versicolor', 'Hyperplan'});
hold off;